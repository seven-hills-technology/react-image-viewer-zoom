    ...
    render() {
        ...
        return (React.createElement("div", { className: "image-wrapper" },
            ...
            React.createElement("div", { className: "tool-bar" },
                ...
                React.createElement("div", { className: "rotatebutton-group" },
                    React.createElement("div", { className: "rotate button", onClick: this.rotate.bind(this) })))));
...
class ImageViewer extends react_1.Component {
    ...
    render() {
        ...
        return (React.createElement("div", { className: `${this.props.className} ${prefixCls}-image-viewer`, ref: (component) => this.container = component },
